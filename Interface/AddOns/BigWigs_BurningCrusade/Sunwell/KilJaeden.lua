...
L:RegisterTranslations("zhTW", function() return {
	...
	kalec_yell = "我會將我的力量導入寶珠中!準備好!",
	kalec_yell2 = "我又將能量灌入了另一顆寶珠!快去使用它!",
	kalec_yell3 = "又有一顆寶珠準備好了!快點行動!",
	kalec_yell4 = "我已經引導出所有的力量了!力量現在掌握在你們的手裡!",
	...
	shadow_message = "28秒後，暗影釘刺",
	shadow_bar = "暗影釘刺",
	shadow_warning = "5秒後，暗影釘刺",
	shadow_debuff_bar = "降低治療：%s",

	shadowdebuff = "關閉暗影減益效果計時條",
	shadowdebuff_desc = "玩家中了暗影減益效果的計時條",
	...
	phase3_trigger = "我是不會失敗的!這個世界注定要毀滅!",
	phase3_message = "第三階段 - 注意千魂之暗",
	phase4_trigger = "別再抱有幻想了!你們不可能贏!",
	phase4_message = "第四階段 - 注意隕石",
	phase5_trigger = "啊呃!太陽之井的能量……開始……對抗我!你們都做了些什麼?你們都做了些什麼??",
...
mod.guid = 25315
mod.toggleOptions = {"phase", -1, "bomb", "orb", "flame", -1, "bloom", "bloomwhisper", "bloomsay", "icons", -1, "sinister", "blueorb", "shadow", "shadowdebuff", "proximity"}

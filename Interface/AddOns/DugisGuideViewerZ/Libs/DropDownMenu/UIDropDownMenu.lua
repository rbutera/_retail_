...
for i = 1, LibDugi_UIDROPDOWNMENU_MAXLEVELS do
	...
	local f = CreateFrame("Button", listFrameName, nil, "LibDugi_UIDropDownListTemplate", "BackdropTemplate");
	f:SetID(i);
	f:SetSize(180, 10);
	...
	for j = 1, LibDugi_UIDROPDOWNMENU_MAXBUTTONS do
		local b = CreateFrame("Button", listFrameName.."Button"..j, f, "LibDugi_UIDropDownMenuButtonTemplate", "BackdropTemplate");
		b:SetID(j);
	end
end

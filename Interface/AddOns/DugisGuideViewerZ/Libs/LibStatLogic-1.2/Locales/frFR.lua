...
PatternLocale.frFR = { -- {{{
	...
	["StatIDLookup"] = {
		["Score de crit"] = {"MELEE_CRIT_RATING", "RANGED_CRIT_RATING", "SPELL_CRIT_RATING"}, -- need for wierd reason. (need to investigate)
	},
} -- }}}
...
DisplayLocale.frFR = { -- {{{
  --ToDo
	...
	["StatIDToName"] = {
		...
		["ARMOR"] = {ARMOR, ARMOR},
		["BONUS_ARMOR"] = {ARMOR.." from bonus", ARMOR.."(Bonus)"},
		...
		["MULTISTRIKE_RATING"] = {"Frappe multiple "..RATING, "Frappe multiple "..RATING},
		["LEECH_RATING"] = {"Ponction "..RATING, "Ponction "..RATING},
		["VERSATILITY_RATING"] = {"Polyvalence "..RATING, "Polyvalence "..RATING},
		["AVOIDANCE_RATING"] = {"Évitement "..RATING, "Évitement "..RATING},

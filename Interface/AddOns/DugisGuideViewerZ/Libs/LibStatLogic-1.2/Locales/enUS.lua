...
PatternLocale.neutral = {
	...
	["NeutralStatIDLookup"] = {
		...
		[RESISTANCE0_NAME] = {"BONUS_ARMOR"}, -- "Armor"
		...
		[ITEM_MOD_EXTRA_ARMOR_SHORT] = {"BONUS_ARMOR"}, -- "Bonus Armor"
		[ITEM_MOD_CR_MULTISTRIKE_SHORT] = {"MULTISTRIKE_RATING"}, -- "Multistrike"
		[ITEM_MOD_CR_LIFESTEAL_SHORT] = {"LEECH_RATING"}, -- "Leech"
		[ITEM_MOD_VERSATILITY] = {"VERSATILITY_RATING"}, -- "Versatility"
		[ITEM_MOD_CR_AVOIDANCE_SHORT] = {"AVOIDANCE_RATING"}, -- "Versatility"
	},
	...
	["NeutralStatIDLookupWithPlaceholders"] = {
		...
		[ITEM_LEVEL_RANGE] = {"PLAYER_LEVEL_REQUIRED", "PLAYER_LEVEL_LIMIT"},
...
PatternLocale.enUS = { -- {{{
	...
	["PreScanPatterns"] = {
		...
		["%d+ secs?[,%.]"] = false, -- Procs
		["Reinforced %(%+(%d+) Armor%)"] = "BONUS_ARMOR",
	...
	["DualStatPatterns"] = { -- all lower case
		...
		["^requires level (%d+) to (%d+)%s?%(?%d*%)?"] = {{"PLAYER_LEVEL_REQUIRED",}, {"PLAYER_LEVEL_LIMIT",},},
	...
	["StatIDLookup"] = {
		...
		["Experience gained is increased%"] = {"XP_BONUS"}, -- Heirlooms  e.g. /sl analyze 42984  Preened Ironfeather Shoulders
		["Experience gained from killing monsters and completing quests increased%"] = {"XP_BONUS"}, -- Heirlooms  e.g. /sl analyze 62040  Ancient Bloodmoon Cloak
...
DisplayLocale.enUS = { -- {{{
	...
	["StatIDToName"] = {
		...
		["ARMOR"] = {ARMOR, ARMOR},
		["BONUS_ARMOR"] = {"Bonus "..ARMOR, "Bonus "..ARMOR},
		...
		["MULTISTRIKE_RATING"] = {"Multistrike "..RATING, "Mastery "..RATING},
		["LEECH_RATING"] = {"Leech "..RATING, "Leech "..RATING},
		["VERSATILITY_RATING"] = {"Versatility "..RATING, "Versatility "..RATING},
		["AVOIDANCE_RATING"] = {"Avoidance "..RATING, "Avoidance "..RATING},

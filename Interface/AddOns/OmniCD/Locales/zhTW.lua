...
L["Always Show Cooldown Numbers"] = "總是顯示冷卻數字"
L["Always Top"] = "總是在上方"
L["Anchor"] = "對齊"
L["Anchor Point"] = "對齊點"
...
L["Mouseovering the icon will show the interrupted spell information regardless of 'Show Tooltip' option."] = "滑鼠指向圖示時會顯示已斷法的法術資訊，無論 '顯示滑鼠提示' 選項是否有啟用。"
